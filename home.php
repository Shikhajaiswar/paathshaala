...
else if(!isset($_SESSION['profile']) || $_SESSION['profile']==true){
    $gg = true;
}
else{
    $loggedin = true;
    ...
    <div class="container-fluid img my-3 shadow bg-secondary ">
        ...
        <div class="row  m-5 ">
            ...
            <div class="col  d-flex justify-content-center ">
                <a href="registration.php"><button class="btn btn-light text-light " style="backgroun bvd-color:#5619a9" >Counselling</button></a>
            </div>
        </div>
        <div class="row">';
        }
        ...
        <div class="row  m-5 ">
            ...
            <div class="col  d-flex justify-content-center ">
                <a href="counselling.php"><button class="btn btn-light text-light " style="background-color:#5619a9" >Counselling</button></a>
            </div>
        </div>
        <div class="row">';
        }
