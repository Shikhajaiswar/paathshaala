...
<body bgcolor="wheat">
    ...
    <div class="row justify-content-around pt-5 back">

        <div class="col-6 animate__animated animate__fadeInDown">
            <div class="p-3 m-4">
                <h1 class="heading   ">Choose<br> Your College Preferences </h1>
                ...
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="choice1" id="country">
                            ...
                            <option value="NSUT-Computer Science and Engineering (Artificial lntelligence)">NSUT-Computer Science and Engineering (Artificial lntelligence)</option>
                            ...
                            <option value="DTU-Computer Science and Engineering (Artificial lntelligence)">DTU-Computer Science and Engineering (Artificial lntelligence)</option>
                            ...
                            <option value="IGDTUW-Computer Science and Engineering (Artificial lntelligence)">IGDTUW-Computer Science and Engineering (Artificial lntelligence)</option>
