...
if ($conn) {
    $id = $_GET['id'];
    $showquery = "select * from registration where applicationno={$id}";
                        ...
                        <fieldset>
                            ...
                            <fieldset>
                                ...
                                <div class="mb-3 p-2">
                                    ...
                                    <div class="row grid ms-2 gap-3">
                                        <input type="text" class="form-control col" id="name" placeholder="First Name" name="fname" value="<?php echo $arrdata['fname'];
                                                                                                                                            ?>" />

                                        <input type="text" class="form-control col" id="name" placeholder="Last Name" name="lname" value="<?php echo $arrdata['lname'];
                                                                                                                                            ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 p-3">
                                    ...
                                    <input type="date" class="form-control" style="width: 12rem" id="dob" placeholder="Date Of Birth" name="dob" value="<?php echo $arrdata['dob'];
                                                                                                                                                        ?>" />
                                </div>
                                ...
                                <div class="mb-3 p-3 row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="country" id="country" value="<?php echo $arrdata['country'];
                                                                                                                                            ?>">
                                ...
                                <div class="mb-3 p-3 row">
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control" id="phone" placeholder="Phone Number" aria-describedby="emailHelp" name="phone" value="<?php echo $arrdata['phone'];
                                                                                                                                                                            ?>" />
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="email" class="form-control" id="exampleInputEmail1" value="<?php echo $arrdata['email'];
                                                                                                                ?>" name="email" placeholder="example@example.com" aria-describedby="emailHelp" />
                                        <div id="emailHelp" class="form-text ms-2">
                            ...
                            <fieldset>
                                ...
                                <div class="mb-3 p-2">
                                    ...
                                    <div class="mb-3 p-1">
                                        <input type="text" class="form-control" id="address" name="a1" placeholder="Address Line 1" value="<?php echo $arrdata['a1'];
                                                                                                                                            ?>" />
                                    </div>
                                    ...
                                    <div class="mb-3 p-1">
                                        <div class="row">
                                            <div class="col-4">
                                                <input type="text" class="form-control" id="address" name="city" placeholder="City" value="<?php echo $arrdata['city'];
                                                                                                                                            ?>" />
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-control" id="address" name="state" placeholder="State" value="<?php echo $arrdata['state'];
                                                                                                                                                ?>" />
                                            </div>
                                            <div class="col-4">
                                                <input type="number" class="form-control" id="address" name="zip" placeholder="Postal / Zip Code" value="<?php echo $arrdata['zip'];
                                                                                                                                                            ?>" />
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <fieldset>
                                                    <div class="mb-3 p-2">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="file" class="form-control" id="inputGroupFile02" name="photo" value="<?php echo $arrdata['photo'];
                                                                                                                                                ?>">
                                                    ...
                                                    <div class="mb-3 p-2">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="file" class="form-control" id="inputGroupFile02" name="sign" value="<?php echo $arrdata['sign'];
                                                                                                                                                ?>">
                                                            <label class="input-group-text" for="inputGroupFile02">Upload</label>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 p-2">
                                                        <div class="p-2" style="width: 32rem;">
                                                            ...
                                                            <input type="number" class="form-control" placeholder="Aadhaar Number, Aadhaar Enrolment ID,
                                                                Aadhaar Registration number, Passport Number, Ration Card Number, Bank Account Number,
                                                                any other valid Government ID Number" id="exampleInputEmail1" name="aadhaarNo" aria-describedby="emailHelp" value="<?php echo $arrdata['aadhaarNo'];
                                                                                                                                                                                    ?>">
                                                    ...
                                                    <div class="mb-3 p-2">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="file" class="form-control" id="inputGroupFile02" name="aadhaar" value="<?php echo $arrdata['aadhaar'];
                                                                                                                                                ?>">
                                                            <label class="input-group-text" for="inputGroupFile02">Upload</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row ms-2 justify-content-center">
                                                        ...
                                                        <div style="width: 15rem">
                                                            ...
                                                            <button type="submit" class="btn btn-primary  mt-3  " name="submit" style="width: 13rem; border-radius :3rem;">Update</button>
