        ...
        <footer>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col item social"><a href="https://www.facebook.com/" target="_blank"><i class="icon ion-social-facebook"></i></a><a href="https://twitter.com/" target="_blank"><i class="icon ion-social-twitter"></i></a><a href="https://linkedin.com/" target="_blank"><i class="icon ion-social-linkedin" target="_blank"></i></a><a href="https://www.instagram.com/"><i class="icon ion-social-instagram" target="_blank"></i></a></div>
                </div>
                <p class="copyright">PaathShaala.Com © 2018</p>
            </div>
        </footer>
    </div>
